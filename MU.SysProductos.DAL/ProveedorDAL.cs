...
namespace MU.SysProductos.DAL
{
    public class ProveedorDAL
    {
        ...
        public ProveedorDAL(MUSysProductosDBContext sysProductosDB)
        {
        ...
        public async Task AgregarTodosAsync(List<Proveedor> proveedores)
        {
            await dbContext.Proveedores.AddRangeAsync(proveedores);
